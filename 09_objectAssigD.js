...
console.log( "Updated Certificates for oracle certified: ",professor.certificates);

console.log("=========== Step 7 =============");
let arrayLength = professor.certificates.length;
console.log("Last element of Certicates array is:",professor.certificates[arrayLength-1]);

console.log("=========== Step 8 =============");
console.log(professor);

console.log("=========== Step 9 (traversing array using for of loop) =============");
